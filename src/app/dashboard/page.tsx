            ...
            <CardContent>
             ...
             <Dialog open={!!viewingPatient} onOpenChange={(isOpen) => !isOpen && setViewingPatient(null)}>
                <DialogContent className="sm:max-w-4xl">
                    ...
                    {viewingPatient && <PatientDetailsDisplay patient={viewingPatient} />}
                </DialogContent>
            </Dialog>
        </Card>
    );
...
function OrderSlipManagementSection() {
    const [orderSlips, setOrderSlips] = React.useState<OrderSlip[]>([]);
    const [selectedOrderSlip, setSelectedOrderSlip] = React.useState<OrderSlip | null>(null);
