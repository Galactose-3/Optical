...
const InvoiceStatusTable = ({ title, invoices, formatCurrency, convertedValues, registerValue, isLoading }: { title: string, invoices: Invoice[], formatCurrency: any, convertedValues: any, registerValue: any, isLoading: boolean }) => {
