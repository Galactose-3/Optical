...
export default function BestSellerCard({ year }: BestSellerCardProps) {
    const [bestSeller, setBestSeller] = React.useState<{ product: Product, unitsSold: number } | null | undefined>(undefined);
