...
import type { Shop, Patient, Invoice } from '@/lib/types';
...
function ShopCard({ shop, clientCount, totalRevenue }: { shop: Shop, clientCount: number, totalRevenue: number }) {
...
export default function LocationReport() {
    ...
    const locationData = React.useMemo(() => {
        ...
        const groupedShops: Record<string, Record<string, Shop[]>> = {};
    ...
    const getShopMetrics = (shopId: string) => {
