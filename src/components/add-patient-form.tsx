...
interface AddPatientFormProps {
    onAddPatient: (patient: Omit<Patient, 'id' | 'lastVisit' | 'loyaltyPoints' | 'loyaltyTier' | 'address' | 'shopId'> & { address: { city: string, state: string } }) => void;
}
...
export function AddPatientForm({ onAddPatient }: AddPatientFormProps) {
    ...
    const renderPrescriptionInputs = (eye: 'right' | 'left', eyeLabel: 'Right Eye (OD)' | 'Left Eye (OS)') => (
