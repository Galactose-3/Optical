...
type StockManagementFormData = z.infer<typeof stockManagementSchema>;

interface StockManagementProps {
    products: Product[];
}

export default function StockManagement({ products: initialProducts }: StockManagementProps) {
    const { toast } = useToast();
    const [products, setProducts] = React.useState(initialProducts);
    const [searchTerm, setSearchTerm] = React.useState('');

    const form = useForm<StockManagementFormData>({
    ...
    const onSubmit = (data: StockManagementFormData) => {
