...
import type { OrderSlip } from '@/lib/types';
...
export function OrderSlipDisplay({ orderSlip }: { orderSlip: OrderSlip }) {
    ...
    const renderPrescriptionRow = (eye: 'rightEye' | 'leftEye', label: string) => {
